...
namespace EM {
    ...
    public class AcknowledgeReport : ReportClass {
    ...
    public class CachedAcknowledgeReport : Component, ICachedReport {
        
        public CachedAcknowledgeReport() {
        }
