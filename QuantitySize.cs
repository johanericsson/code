...
namespace EM {
    ...
    public class QuantitySize : ReportClass {
    ...
    public class CachedQuantitySize : Component, ICachedReport {
        
        public CachedQuantitySize() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            QuantitySize rpt = new QuantitySize();
            rpt.Site = this.Site;
            return rpt;
        }
