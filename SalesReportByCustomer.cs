...
namespace EM {
    ...
    public class SalesReportByCustomer : ReportClass {
        ...
        public override string ResourceName {
            get {
                return "SalesReportByCustomer.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesReportByCustomer : Component, ICachedReport {
        
        public CachedSalesReportByCustomer() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesReportByCustomer rpt = new SalesReportByCustomer();
            rpt.Site = this.Site;
            return rpt;
        }
